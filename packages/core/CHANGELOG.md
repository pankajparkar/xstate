...
- [`9d34092`](https://github.com/davidkpiano/xstate/commit/9d34092997b2e3ae5136056f144d2b7083c91ec9) [#1037](https://github.com/davidkpiano/xstate/pull/1037) Thanks [@Andarist](https://github.com/Andarist)! - Interpreter no longer accepts a `clock` option. It just uses plain `setTimeout` and `clearTimeout`.
